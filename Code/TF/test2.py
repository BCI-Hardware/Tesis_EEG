...
predictions_file_name = 'predictions/predictions_' + data_date + '_2e6_N_30.txt'

input_data = list(csv.reader(open('input_data/input_' + data_date + '_copy.txt')))
output_data = list(csv.reader(open('input_data/output_' + data_date + '_copy.txt')))
...
# Network parameters
n_hidden = 30 # number of neurons for the hidden layer
n_input = 2
n_output = 2
